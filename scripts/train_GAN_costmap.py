...
parser.add_argument('--dataset_name', type=str, default="train-gan-costmap-dropout-02", help='name of the dataset')
...
for i, batch in enumerate(train_loader):
    ...
    pred_fake = discriminator(fake_traj_with_condition)
    loss_G = torch.mean(pred_fake) + 1*start_point_loss + 1*start_v_loss
    loss_G.backward()
