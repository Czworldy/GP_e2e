...
parser.add_argument('--dataset_name', type=str, default="pretrain-encoder-07", help='name of the dataset')
...
generator.load_state_dict(torch.load('../result/saved_models/train-gan-02/generator_20000.pth'))
