...
parser.add_argument('--dataset_name', type=str, default="r2k-points4", help='name of the dataset')
...
parser.add_argument('--test_interval', type=int, default=1, help='interval between model test')
...
model.load_state_dict(torch.load('result/saved_models/%s/model_%d.pth'%('train-DIM-02', 217000)))
