...
parser.add_argument('--dataset_name', type=str, default="adversarial-02", help='name of the dataset')
...
discriminator = Discriminator(input_dim=256, output=opt.model_num).to(device)
...
d_optimizer = torch.optim.Adam(discriminator.parameters(), lr=1e-4, weight_decay=opt.weight_decay)
...
for total_steps in range(1000000):
    ...
    if True:
        ...
        prediction = discriminator(feature)
        # import pdb; pdb.set_trace()
        ...
        loss = uncertainty_loss + 10*g_loss
