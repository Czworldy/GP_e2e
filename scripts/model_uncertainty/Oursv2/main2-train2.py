...
parser.add_argument('--dataset_name', type=str, default="main-IRM-two-models-09", help='name of the dataset')
...
if not opt.test_mode:
    logger = SummaryWriter(log_dir=log_path+'/IRM-wo-l2')
    logger2 = SummaryWriter(log_dir=log_path+'/Ada-IRM')
