...
from learning.model import Generator, Discriminator, Encoder, Generatorv2, MobileNetV2, RNNEncoder, CNN, DoubleCNN,MixStyleEncoder
...
parser.add_argument('--dataset_name', type=str, default="train-ganlosss-mixstyle-06", help='name of the dataset')
...
scheduler = torch.optim.lr_scheduler.StepLR(e_optimizer, 200, gamma=0.1)
...
for i, batch in enumerate(train_loader):
    ...
    penalty_weight = 0.001#(0.1 if total_step >= 2000 else 0.01)
