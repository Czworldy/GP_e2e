...
from learning.model import Generator, Discriminator, Encoder, Generatorv2, MobileNetV2, RNNEncoder, CNN, MixStyleEncoder
...
parser.add_argument('--dataset_name', type=str, default="main-mixstyle-02", help='name of the dataset')
# parser.add_argument('--dataset_name', type=str, default="main-new-g-01", help='name of the dataset')
